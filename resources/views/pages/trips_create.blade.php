...
@section('content')
    <div class="col-lg-8 offset-lg-2">
        ...
        <h2 class="text-center mb-3">Create a Trip</h2>
                ...
                <div class="col-lg-6">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="from_location_id" class="form-control">
                                @foreach ($locations as $location)
                                    <option
                                        value="{{ $location->id }} {{ old('from_location_id') == $location->id ? 'selected' : '' }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="to_location_id" class="form-control">
                                @foreach ($locations as $location)
                                    <option
                                        value="{{ $location->id }} {{ old('to_location_id') == $location->id ? 'selected' : '' }}"">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="available_seats" class="form-control" value="36">
                        ...
                        @foreach ($locations as $location)
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="location_{{ $location->id }}_price" class="form-control"
                                    value="{{ old('location_' . $location->id . '_price') }}">
                        ...
                        <div class="form-group mb-3">
                            <div class="form-check">
                                ...
                                <input type="checkbox" name="round_trip" value="1" class="form-check-input"
                                    id="roundTrip" {{ old('round_trip') ? 'checked' : '' }}>
